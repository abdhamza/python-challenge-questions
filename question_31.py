# 31) Create a program where the user enters five movie names to store in a list. After the list is created, ask the user for a movie name to remove from the list. 
